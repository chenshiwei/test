...
object NativeBayesTest {

    def loadDataSet(): (Array[Array[String]], Array[Int]) = {
    ...
    def setOfWords2Vec(vocabList: Array[String], inputSet: Array[String]): Array[Int] = {
    ...
    def trainNB0(trainMatrix: Array[Array[Int]], trainCategory: Array[Int]): (Array[Double], Array[Double], Double) = {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val trainMat = new ArrayBuffer[Array[Int]](listOPosts.length)
